...
void circle_imp_print_2d ( double r, double center[2], char *title );
...
void r8mat_transpose_print_some ( int m, int n, double a[], int ilo, int jlo, 
  int ihi, int jhi, char *title );
double *r8mat_uniform ( int m, int n, double alo, double ahi, int *seed );
...
double *r8vec_uniform ( int n, double alo, double ahi, int *seed );
